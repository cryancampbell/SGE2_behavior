...
for (rowNum in 1:dim(dataCombos)[1]) {
  ...
  writeLines(c(paste0("SGEII Phase ",sgePhase),
               ...
               paste0("StDev Group Directional Consistency = ",sdDCI)),methodsOut)
  close(methodsOut)
}
```
...
comboP1P2$rawGroomRate <- 2 * (comboP1P2$totGroomMin / comboP1P2$totObs)
comboP1P2$rawAggRecRate <- 2 * (comboP1P2$totAggRec / comboP1P2$totObs)
