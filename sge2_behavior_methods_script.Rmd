...
for (rowNum in 1:dim(dataCombos)[1]) {
  ...
  if (sgePhase == 1) {
    ...
    dateDF <- samplingDates[!is.na(samplingDates$groupP2),c(1,7)]
  ...
  if ( !adjustData ) {
      dateDF$date <- max(sge2dates$date)
  }
  ...
  #NSPF4 + DJ --> D2
  if ( sgePhase == 2 ) {
    #there are 2 DJ's in phase 2, RDj7 in NSPF4 is "D2"
